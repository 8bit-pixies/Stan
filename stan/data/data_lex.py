...
from stan.data.data_expr import EXPR_, ID_, DATA, SET, RENAME, RUN, DROP, KEEP, SEMI_, LOGICAL_, SASLOGICAL_
...
dataStepStmt << (data_stmt + 
                 ...
                 ZeroOrMore(SASLOGICAL_.setResultsName('saslogical') + SEMI_)) + 
                 RUN + SEMI_)
